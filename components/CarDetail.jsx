      ...
      <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
        <div className="relative mt-51 md:mt-4 bg-[#161616] p-8 w-full md:w-3/4 rounded-lg shadow-lg max-h-[80vh] overflow-y-auto">
          <img
            ...
            onClick={closeModal}
          />
          <h2 className="font-chakra font-bold text-center text-[24px] mb-4">Información del Carro</h2>
          {/* Mostrar información del carro seleccionado */}
          {selectedCar && (
            <div>
              <div className="max-w-[520px] mx-auto mb-4">
                <img src={selectedCar.image} alt={selectedCar.name} className="w-full h-auto md:mb-4" />
              </div>
              <div className="max-w-[320px] mx-auto">
                 ...
                 <div className="flex flex-col md:flex-row justify-between mb-4">
                   ...
                   <p><strong>Versión:</strong> {selectedCar.version || 'N/A'}</p>
                 </div>
              </div>
